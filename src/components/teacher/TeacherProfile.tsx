      ...
      <div className="w-full flex flex-col items-center space-y-4">
        <Link
          ...
          className={`font-semibold text-lg ${
            pathname.includes("/assessments") ? "text-blue-500" : "text-gray-900"
          }`}
        >
          Assessments
        </Link>
        <Link
          href="/answer-sheets"
          className={`font-semibold text-lg ${
            pathname.includes("/answer-sheets") ? "text-blue-500" : "text-gray-900"
          }`}
        >
          Answer Sheets
        </Link>
        <Link
          ...
          className={`font-semibold text-lg ${
            pathname.includes("/account-settings") ? "text-blue-500" : "text-gray-900"
          }`}
        >
          Account Settings
        </Link>
